...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ParameterValue = QtWidgets.QTextEdit(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ParameterValue.sizePolicy().hasHeightForWidth())
        self.ParameterValue.setSizePolicy(sizePolicy)
        self.ParameterValue.setMinimumSize(QtCore.QSize(0, 0))
        self.ParameterValue.setMaximumSize(QtCore.QSize(16777215, 32))
        self.ParameterValue.setObjectName("ParameterValue")
        self.gridLayout.addWidget(self.ParameterValue, 1, 1, 1, 1)
